...
declare function PostScribe({ html, afterAsync, afterDequeue, afterStreamStart, afterWrite, done, autoFix, beforeEnqueue, beforeWrite, beforeWriteToken, error, releaseAsync, }: PostScribeProps): react.DetailedReactHTMLElement<react.HTMLAttributes<HTMLDivElement>, HTMLDivElement>;

export { PostScribeProps, Token, PostScribe as default };
